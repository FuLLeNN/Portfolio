...
const Projects = () => {
    /*return (
      <div className={ProjectStyles.project}>
        ...
        <div className={ProjectStyles.soon}>
          ...
          <p className={ProjectStyles.underConstruct}>Under construction...</p>
        </div>
        <BackgroundAnimation />
        ...
        <div className={ProjectStyles.project}>
            ...
            <div className={ProjectStyles.cardgroup}>
                <div className="card card1">
                    ...
                    <div className={ProjectStyles.buttongroup}>
                        <a href="https://www.rigacup.lv/" target="_blank">
                            <button>Demo</button>
                        </a>
                    </div>
                </div>
                <div className="card card1">
                    ...
                    <div className={ProjectStyles.buttongroup}>
                        ...
                        <a href="https://github.com/FuLLeNN/Chess" target="_blank">
                ...
                <div className="card card1">
                    ...
                    <hr/>
                    <p>
                        Simple To Do API made in class.<br/>
                        Tech: .NET(C# and Swagger for documentation)
                    </p>
                    ...
                    <div className={ProjectStyles.buttongroup}>
                        ...
                        <a href="https://github.com/FuLLeNN/TodoAPI" target="_blank">
                            <button>Source</button>
                        </a>
                    </div>
                </div>
            ...
            <div className={ProjectStyles.cardgroup}>
                <div className="card card1">
                    ...
                    <hr/>
                    <p>
                        Tic Tac Toe made in JavaScript with 2 versions (Functional and Object Oriented).<br/>
                    ...
                    <div className={ProjectStyles.buttongroup}>
                        ...
                        <a href="https://github.com/FuLLeNN/tic-tac-toe/" target="_blank">
                            <button>Source</button>
                        </a>
                    </div>
                </div>
                <div className="card card1">
                    ...
                    <hr/>
                    <p>
                        Reddit Clone for an university assignment<br/>
                        Tech: .NET (C#, Blazor, JWT)
                    </p>
                    ...
                    <div className={ProjectStyles.buttongroup}>
                        ...
                        <a href="https://github.com/FuLLeNN/FakeReddit" target="_blank">
                            <button>Source</button>
                        </a>
                    </div>
                </div>
